      ...
      newsSentiment: [
        {
          ...
          articles: [
            { title: "NVIDIA Smashes Q3 Estimates as Data Center Revenue Hits Record $30.8B", url: 'https://finance.yahoo.com', publishedAt: daysAgo(3).toISOString(), sentiment: 'positive' },
            { title: "Jensen Huang: Blackwell Demand is 'Insane' — Production Ramping Ahead of Schedule", url: 'https://finance.yahoo.com', publishedAt: daysAgo(5).toISOString(), sentiment: 'positive' },
            { title: "NVIDIA Faces Export Control Scrutiny on H20 Chips Destined for China", url: 'https://finance.yahoo.com', publishedAt: daysAgo(8).toISOString(), sentiment: 'negative' },
            { title: "Analysts Raise NVDA Price Targets to $200 Following Blowout Quarter", url: 'https://finance.yahoo.com', publishedAt: daysAgo(10).toISOString(), sentiment: 'positive' },
          ],
        ...
        },
        {
          ...
          articles: [
            { title: "AMD MI300X Wins Key Cloud Contracts as AI Chip Race Intensifies", url: 'https://finance.yahoo.com', publishedAt: daysAgo(4).toISOString(), sentiment: 'positive' },
            { title: "AMD Q3 Revenue Misses High-End Estimates; Data Center Growth Slower Than Peers", url: 'https://finance.yahoo.com', publishedAt: daysAgo(7).toISOString(), sentiment: 'negative' },
            { title: "AMD Cuts PC CPU Prices as Intel Regains Ground in Consumer Market", url: 'https://finance.yahoo.com', publishedAt: daysAgo(12).toISOString(), sentiment: 'negative' },
          ],
          source: 'Yahoo Finance News',
        },
      ],
      ...
      newsSentiment: [
        {
          ...
          articles: [
            { title: "Tesla Q3 Deliveries Beat Estimates at 462,890 — Stock Jumps 8% After-Hours", url: 'https://finance.yahoo.com', publishedAt: daysAgo(6).toISOString(), sentiment: 'positive' },
            { title: "Elon Musk Says FSD Will Be Licensed to Other Automakers — Potential $10B Revenue Stream", url: 'https://finance.yahoo.com', publishedAt: daysAgo(9).toISOString(), sentiment: 'positive' },
            { title: "Tesla Cuts Model 3 and Model Y Prices in Europe Amid Weakening Demand", url: 'https://finance.yahoo.com', publishedAt: daysAgo(14).toISOString(), sentiment: 'negative' },
            { title: "Tesla Cybertruck Production Reaches 1,000 Units/Week — Still Significantly Below Plan", url: 'https://finance.yahoo.com', publishedAt: daysAgo(18).toISOString(), sentiment: 'neutral' },
            { title: "BYD Outsells Tesla in Europe for First Time — EV Competition Intensifies", url: 'https://finance.yahoo.com', publishedAt: daysAgo(22).toISOString(), sentiment: 'negative' },
          ],
          source: 'Yahoo Finance News',
        },
      ],
      ...
      newsSentiment: [
        {
          ...
          articles: [
            { title: "Apple Intelligence Features Roll Out to iPhone 16 — Early User Reception Mixed", url: 'https://finance.yahoo.com', publishedAt: daysAgo(5).toISOString(), sentiment: 'neutral' },
            { title: "Apple Services Revenue Hits $24.2B in Q4 — Record High, Up 12% YoY", url: 'https://finance.yahoo.com', publishedAt: daysAgo(8).toISOString(), sentiment: 'positive' },
            { title: "iPhone 16 Sales in China Disappoint as Huawei Mate 60 Gains Traction", url: 'https://finance.yahoo.com', publishedAt: daysAgo(15).toISOString(), sentiment: 'negative' },
          ],
          source: 'Yahoo Finance News',
        },
        {
          ...
          articles: [
            { title: "Microsoft Azure Revenue Grows 33% — AI Services Now $10B Annualized Run Rate", url: 'https://finance.yahoo.com', publishedAt: daysAgo(4).toISOString(), sentiment: 'positive' },
            { title: "Microsoft Copilot Reaches 1M Paid Enterprise Seats — Monetization Accelerating", url: 'https://finance.yahoo.com', publishedAt: daysAgo(7).toISOString(), sentiment: 'positive' },
            { title: "EU Opens Investigation into Microsoft-OpenAI Partnership Over Competition Concerns", url: 'https://finance.yahoo.com', publishedAt: daysAgo(20).toISOString(), sentiment: 'negative' },
          ],
          source: 'Yahoo Finance News',
        },
      ],
      ...
      newsSentiment: [
        {
          ...
          articles: [
            { title: "NVIDIA Blackwell GPU Shipments Begin — Microsoft and Google First to Receive", url: 'https://finance.yahoo.com', publishedAt: daysAgo(3).toISOString(), sentiment: 'positive' },
            { title: "Goldman Sachs: AI Infrastructure Spend to Reach $1T by 2028 — NVIDIA Primary Beneficiary", url: 'https://finance.yahoo.com', publishedAt: daysAgo(11).toISOString(), sentiment: 'positive' },
          ],
          source: 'Yahoo Finance News',
        },
      ],
